...
def get_args():
    ...
    parser.add_argument('--decomp_type', default='eig', help='decomposition (default: eig, choices: eig, svd, full_eig)')
    parser.add_argument('--transfer', type=bool, default=False, help='whether to run the transfer setting or not (default: False)')
    parser.add_argument('--control', type=bool, default=True, help='whether to run the control or policy evaluation (default: True)')
